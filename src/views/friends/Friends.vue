  ...
  <div class="about">
    ...
    <v-col cols="11" md="8" class="mx-auto">
      ...
      >
        ...
        <v-card-text
          >可在评论里告诉我你的博客地址(name,bio,URL,avatar)</v-card-text
        >
        <v-card-text class="text-start pa-3" style="user-select: text">
          ...
          >
          <v-card-text class="pa-1"
            >Avatar: https://s1.ax1x.com/2020/03/19/8yvQWq.jpg</v-card-text
          >
        </v-card-text>
      </v-card>
      <v-card
        color="rgba(255,255,255,0.8)"
        class="mx-auto my-3 friendsLink"
        outlined
      >
        <Comment />
        <CommentList :blogID="''" />
    ...
    <v-img
      eager
      v-if="!isMobile"
      src="https://cdn.kagurakana.xyz/love-down.png"
    ></v-img>
  </div>
</template>
